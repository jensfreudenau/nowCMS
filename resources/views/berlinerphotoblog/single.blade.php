...
<x-berlinerphotoblog.layout>
    @if($content->is_text)
        <x-berlinerphotoblog.article :content="$content" :single="true"/>
        <div class="mt-24 pt-0 border-b-1 border-gray-400 "></div>
        <div class="flex justify-between pl-2 pr-1 py-1 text-sm">
            <div>
    ...
    @else
        ...
        <div class="pt-5 gap-4 text-sm">
            <x-berlinerphotoblog.gallery :content="$content" single="true" :gallery="$content->category?->name"/>
            <div class="mt-24 pt-0 border-b-1 border-gray-400 "></div>
