                ...
                @endif
                        ...
                        <div class="px-12 pt-10">
                            ...
                            <input type="text"
                                   ...
                                   id="tags"
                                   name="tags"
                                   class="tagify mt-0 block w-full px-0.5 border-0 border-b-2 border-gray-200 focus:ring-0 focus:border-black" autofocus>
                        </div>
                    ...
                    @if (isset($content))
                       <div class="px-12">
                        ...
                        @foreach( $mediaItemsAll->all() as $key => $mediaItems)
                                   <li class="flex border-2 py-4 mb-2 pb-3" data-media-id="{{$mediaItems->id}}" id="list_{{$mediaItems->id}}" data-id="{{$mediaItems->id}}">
                            <div class="flex w-1/2 flex-wrap admin" id="image_list_{{$mediaItems->id}}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-3 p-12">
                            {!!  Str::markdown(old('text', $content->text ?? '')) !!}
                        </div>
                   @endif
        </div>
    </div>
    ...
    @push('js_after')
        ...
        <script type="module">
            ...
            function makeEditButton(el) {
                ...
                div.innerHTML = '<a href="javascript:void(0)"><img src="{{ URL::to('/') }}/images/stackedit.svg"></a>';
            ...
            const textareaEl = document.getElementById('contentText');
