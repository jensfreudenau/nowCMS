        ...
        <div class="px-2 grid grid-cols-2 gap-4 pb-8">
            ...
            <div class="container ml-3 px-0 border-b-1">
                <div class="relative mb-5 min-h-[570px]">
                    ...
                    <h2 class="pb-2 text-base"><a href="/single/{{$content->slug}}" class="hover:text-mint-500">{{$content->header}}</a></h2>
                    ...
                    @endif
                    <p class="mt-2 ">
                        in: <a href="/getCategory/{{$content->category?->name}}" class="hover:text-mint-500">{{$content->category?->name}}</a>
                    </p>
