<nav class="flex flex-col md:flex-row sm:flex-row mt-2">
    <div class="container mx-auto flex justify-between items-center uppercase">
        ...
        <ul id="menu" class="hidden md:flex space-x-4 text-white">
            ...
            <li><x-link class="text-pink-500" href="https://blog.freude-now.de" title="Blog">{{__('Blog')}} -</x-link></li>
            <li><x-link class="text-pink-500" href="https://blog.freude-now.de/about" title="about">{{__('about')}}</x-link></li>
        </ul>
