<x-freudefoto.layout>
    ...
    @push('meta_after')
        ...
        <meta name="description" content="{{Config::get('domains.titles.freudefoto_title')}} - {{$journey->name_of_route}}">
    ...
    <div class="flex flex-col">
        <article class="shadow-md bg-white dark:bg-gray-800 dark:text-white tracking-wide pb-24">
            ...
            >
            <h1 class="px-52 font-bold text-5xl py-11">
                {!! $journey->name_of_route !!}
            </h1>
            <div class="p-12">
