@push('meta_after')
    <meta name="description" content="{{config('app.freude_now_blog_title')}} - {{__('about me')}}">
    <link rel="canonical" href="{{Config::get('app.base_domain')}}/about">
    <title>{{config('app.freude_now_blog_title')}} - {{__('about me')}}</title>
@endpush
